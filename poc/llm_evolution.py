...
async def main():
    ...
    # --- OLLAMA CONFIGURATION START ---
    # Configure the LLM client to point to Ollama
    ...
    # Configure the Embedder to use a local model via Ollama
    ...
    # Configure the Cross-Encoder to use the same Ollama LLM
    cross_encoder = OpenAIRerankerClient(client=llm_client, config=llm_config)

    # Initialize Graphiti with the custom Ollama clients
    graphiti = Graphiti(
        neo4j_uri,
        neo4j_user,
        neo4j_password,
